...
import { ChevronDown, Settings, MessageCircle, Users2, Share2, Menu } from 'lucide-react';
      ...
      <header className="bg-gray-900 border-b border-gray-800">
        <nav className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            {/* Auth Buttons */}
            <div className="hidden md:flex items-center space-x-3 ml-150">
              <button className="px-6 py-2 text-white hover:text-gray-300 transition-colors border border-gray-600 rounded-full">
                Join
              </button>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2  lg:grid-cols-4 gap-6">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Join the ultimate Valorant experience today!
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Connect with our community and grow together.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Stay updated with us on social media platforms.
                </p>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <p className="text-gray-300 text-lg leading-relaxed max-w-lg">
                Precision, teamwork, and raw aim - welcome to the next level of competitive FPS. Join us as we redefine what it means to compete in Valorant.
              </p>
              ...
              <div className="flex items-center space-x-4">
                ...
                <button className="px-8 py-3 border-gray-600 hover:border-gray-500 text-white font-medium rounded-full">
                  Join
                </button>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="bg-gray-600 rounded-lg aspect-video flex items-center justify-center">
                <div className="text-center">
                   <svg className="w-8 h-16 bg-gray-500 rounded-lg mx-auto mb-4 flex items-center justify-center">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="flex space-x-1">
                 <div class="w-8 h-8 border-4 border-white rounded-full -ml-0"></div>
                 <div class="w-8 h-8 border-4 border-white rounded-full -ml-4"></div>
              </div>
              ...
              <p className="text-gray-300 text-lg leading-relaxed max-w-lg">
                From humble beginnigs to elite competition, our team thrives on precision and teamwork. We are dedicated to mastering every angle of the game and pushing the boundaries of what's possible in Valorant
              </p>

              {/* Action Buttons */}

              <div className="flex items-center space-x-4">
                <button className="px-8 py-3 border-gray-500 hover:border-gray-400 text-white font-medium rounded-full transition-colors border-full">Learn More</button>
